...
public class MyEJB10Test {
        ...
        try {
            ...
            while (choice != 4) {
                ...
                if (choice == 1) {
                    ...
                    System.out.println(libBean.getVitriFromTaikhoan(_username, _password));
    ...
    public void testEntityEJB2() {
        try {
            ...
            String _vitri = libBean.getVitriFromTaikhoan(_username, _password);
            ...
            while (decision != 4) {
                ...
                switch (decision) {
                    ...
                    case 3:
                        ...
                        System.out.print("\n23. Show all nhanvien \n24. Show all taikhoan \n25. Show all vitri \n26. Show all phieu \n27. showAllNhacc \n28. showAllHhp \n29. showAllHanghoa \n30. showAllHdhh \n31. showAllHoadon \n4. Exit \nEnter Choice: ");
